...
from deeplab_resnet import DeepLabResNetModel, ImageReader, prepare_label, decode_labels, inv_preprocess, dense_crf
...
def get_arguments():
    ...
    """
    parser = argparse.ArgumentParser(description="Discovering Class Specific Pixels (DCSP) Evaluation on Server Script.")
...
def main():
    ...
    pred = tf.py_func(dense_crf, [raw_output, inv_image], tf.float32)
