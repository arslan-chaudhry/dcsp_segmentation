...
from deeplab_resnet import DeepLabResNetModel, ImageReader, prepare_label, inv_preprocess, dense_crf
...
def get_arguments():
    ...
    """
    parser = argparse.ArgumentParser(description="Discovering Class Specific Pixels (DCSP) Evaluation Script.")
